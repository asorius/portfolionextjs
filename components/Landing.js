    ...
    <div
      ...
      <div className='flex flex-col justify-center items-center h-full relative'>
        ...
        <div className=' w-full flex flex-col justify-between items-center pb-4'>
          {/* <Atom /> */}
          <h2 className='text-3xl text-text-dark dark:text-text-light pb-8 pt-4 mb-12 opacity-0 animate-fade-in-long text-center'>
            Web Developer
            <svg
              width='517'
              height='62'
              ...
              <path
                ...
                className='fill-text-dark dark:fill-accent-dark '
              />
            </svg>
          </h2>
          <button
