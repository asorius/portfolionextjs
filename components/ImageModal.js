  ...
  return (
    <div
      ...
      <button
        ...
        className='duration-100 absolute top-0 left-0 w-full h-full bg-neutral-900 opacity-70 text-8xl text-text-light hover:text-button-primary hover:text-9xl'
        title='enlarge'>
        +
      </button>
    </div>
