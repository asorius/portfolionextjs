  ...
  return (
    <section id='about' className='bg-container dark:bg-container-dark pb-10'>
      <div className='container px-6 py-8 container mx-auto'>
        <FadeInner>
          <h2 className={'dark:text-text-primary ' + heading1}>
            <Heading
              title='About me'
              sideText='me'
              size='15rem'
          ...
          <div className='items-center md:flex max-w-3xl mx-auto pt-14'>
            <div className='md:w-1/2'>
              <p className='mt-4 text-text-primary lg:max-w-md py-6 md:text-right'>
              ...
              <div className='flex justify-end items-center mt-6 -mx-2 md:justify-end'>
                ...
                <Link
                  ...
                  <a title='My Github'>
                    <svg
                      className='w-7 h-7 text-text-primary fill-current hover:text-accent-secondary dark:hover:text-accent-secondary hover:scale-125 duration-300'
                      xmlns='http://www.w3.org/2000/svg'
                      viewBox='0 0 512 512'>
                ...
                <Link
                  ...
                  <a title='Send me email' className='mx-2 inline-block'>
                    <FontAwesomeIcon
                      icon={faEnvelope}
                      className='transition duration-300 hover:scale-112 w-7 h-7 text-text-primary fill-current dark:text-text-primary-darkmode dark:hover:text-accent-secondary hover:text-accent-secondary hover:scale-125'
                    />
                  </a>
                </Link>
              </div>
