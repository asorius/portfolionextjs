  ...
  return (
    <svg
      ...
      <path
        ...
        className='stroke-text-primary dark:stroke-text-primary-dark animate-wiggle'
        strokeWidth='4'
      />
      <circle
        r='10'
        className='fill-accent-pink dark:fill-accent-pink animate-baller  '
        style={{
      ...
      <circle
        ...
        cy='103'
        r='20'
        className='fill-text-primary dark:fill-text-primary-dark animate-fade-in-down '
      />
    </svg>
  );
}
