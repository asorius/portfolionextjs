...
export default function CardBody({ comment, stack, links, openState }) {
  return (
    <div
      className={`w-full transition duration-200 ease-in-out rounded drop-shadow-lg dark:text-text-dark-dark text-center lg:-z-10 p-0 transform -translate-y-10 ${
        openState
          ? 'opacity-1 scale-1 max-h-auto'
          : 'opacity-0 max-h-1 scale-0 lg:opacity-100 lg:scale-100 lg:max-h-full'
